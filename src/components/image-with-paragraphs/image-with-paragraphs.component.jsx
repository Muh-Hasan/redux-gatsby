...
const ImageWithParagraphsComponent = ({
  title,
  id,
  imageUrl,
  bodyContent,
  ...
  <section className="container-fluid block-container-3 image-2-paragraphs">
    ...
    {sectionCopy3 && (
      <div className="row justify-content-around" id={`${sectionId3}`}>
        <div className="col-md-8 col-sm-12 ">
          <h4>{sectionHeader3}</h4>
          <p className="border-bottom">{sectionCopy3}</p>
        </div>
      </div>
    )}
    {sectionCopy4 && (
      <div className="row justify-content-around">
        <div className="col-md-8 col-sm-12 ">
          <p className="border-bottom">{sectionCopy4}</p>
        </div>
      </div>
    )}
...
export default ImageWithParagraphsComponent
